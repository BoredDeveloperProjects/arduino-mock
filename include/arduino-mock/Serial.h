  ...
  */
  void mock_buffer_load(uint8_t buffer[], const uint8_t len, bool ignore_calls = true) {
    ...
    if (ignore_calls) {
      ...
      EXPECT_CALL(*this, read()).WillRepeatedly(DoDefault());
  ...
  /**
    \brief Constructor. Sets default mock actions for available, read and
    operator [], to be redirected to SerialFake
  */
  /*SerialMock() {
...
class Serial_ : public Print {
 ...
 public:
  ...
  virtual size_t print(int, int = DEC) override;
  virtual size_t print(unsigned int, int = DEC) override;
  virtual size_t print(long, int = DEC) override;
  virtual size_t print(unsigned long, int = DEC) override;
  virtual size_t print(double, int = 2) override;

  virtual size_t println(const char[]) override;
  virtual size_t println(char) override;
  virtual size_t println(unsigned char, int = DEC) override;
  virtual size_t println(int, int = DEC) override;
  virtual size_t println(unsigned int, int = DEC) override;
  virtual size_t println(long, int = DEC) override;
  virtual size_t println(unsigned long, int = DEC) override;
  virtual size_t println(double, int = 2) override;
  virtual size_t println(void) override;
