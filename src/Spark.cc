...
void Spark_::connect() { gSparkMock->connect(); }

void Spark_::disconnect() { gSparkMock->disconnect(); }

bool Spark_::connected() { return gSparkMock->connected(); }

void Spark_::process() { gSparkMock->process(); }

char *Spark_::deviceID() { return gSparkMock->deviceID(); }

void Spark_::sleep() { gSparkMock->sleep(); }
...
void Spark_::syncTime() { gSparkMock->syncTime(); }
